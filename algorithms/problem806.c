...
int* numberOfLines(int* widths, int widthsSize, const char* S, int* returnSize)
{
    int lines = 0;
    int lchars = 0;
    const char *ptr = S;
...
int main(int argc, char** argv)
{
    ...
    const char* s = "bbbcccdddaaa";
    
    int *ret;
    int wlen;
    
    ret = numberOfLines(w, sizeof(w)/sizeof(w[0]), s, &wlen);
